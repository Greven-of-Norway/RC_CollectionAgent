...
function LrMetadata:new( t )
    ...
    o.other = tab:createSet{ 'array', 'struct', 'proxy' } -- @19/Jan/2015 21:11, "array" means "array of Lr objects" (e.g. LrPhoto, LrKeyword). "struct" means "table of items, sometimes a key/value table but sometimes an array - items are sometimes simple and sometimes tables". "proxy" means item defined elsewhere (e.g. in advanced settings), and referred to here.
    return o
end
...
--]]        
        ...
        { id='imageSupplier', friendly="Image Supplier", dataType='struct', viewType='' }, -- ###2 ?
