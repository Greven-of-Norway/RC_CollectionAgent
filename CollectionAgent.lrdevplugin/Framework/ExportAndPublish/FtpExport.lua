...
function FtpExport:_initFtpService( srvcName )
    ...
    local ftpSettings = {
        ...
        password=self.exportParams[self.ftpPropertyMap.password], -- ###2? (17/Mar/2014 18:01)   or error( "no password field in export params" ), -- can be blank, but shouldn't be missing, although I suppose it could be..
...
function FtpExport:finale( service )
    ...
    Export.finale( self, service, service.status, service.message ) -- old-style calling for compatibility, I guess (doesn't hurt to pass extra params) ###2.
