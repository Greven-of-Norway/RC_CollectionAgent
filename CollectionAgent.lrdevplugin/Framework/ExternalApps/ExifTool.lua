...
--- Execute a read command, which emulates like method of session object.
--  @param tmo (number, optional) timeout in seconds.
--  @return result (string) non-nil => got result.
--  @return errorMessage (string) non-nil => error description.
--  @return command (string) non-nil => equivalent command.
...
--- Execute a write command, which emulates like method of session object.
--  @param tmo (number, optional) timeout in seconds.
--  @return status (boolean) true => written, false => error.
--  @return errorMessage (string) if status false => error description.
