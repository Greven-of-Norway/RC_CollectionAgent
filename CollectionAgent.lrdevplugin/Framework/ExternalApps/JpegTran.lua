...
function JpegTran:new( t )
    ...
    t.macAppName = t.macAppName or "jpegtran" -- ###2 if included with plugin, also: pre-requisite condition for mac-default-app-path to be used instead of mac-pathed-name, if present on system.
