...
--[[
        May not work in Lion, may need: ###2 test on Mac
...
function Mac:makeFolderLink( linkPath, folderPath )
    local cmd = "ln"
    local parms = str:fmtx( '/s "^1"', folderPath ) -- ###2 test on Mac - this does not look right - should be '-s' I would think..
...
--- mac implementation of operating-system--make-folder-link. ###2 test on Mac
--
