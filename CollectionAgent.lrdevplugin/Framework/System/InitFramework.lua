...
function Init:framework()
    ...
    --gbl:initVar( 'stopped', false, reloading ) -- debug stopped. ### need to think about this some more.
    ...
    gbl:initVar( 'intercom', objectFactory:newObject( Intercom ), reloading ) -- ###2 some plugins may be recreating this (note: polling-interval defaults to .1).
